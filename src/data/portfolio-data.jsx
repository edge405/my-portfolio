...
import { FaCat, FaCoffee, FaAward, FaCode, FaBriefcase } from "react-icons/fa";
...
export const portfolio = {
  ...
  seo: {
    ...
    description:
      "Hi, I'm Edjay Lindayao, a full stack developer specializing in React, Vite, and modern web technologies. Check out my projects and contact me.",
    keywords:
      "Edjay Lindayao, Full Stack Developer, React Developer, Vite, Web Developer, Portfolio",
  ...
  stats: [
    { label: "Projects Completed", value: "16+", icon: FaBriefcase },
  ...
  quickFacts: [
    ...
    },
    {
      icon: FaBolt,
      color: "text-red-400",
      text: "Hackathon participant and coding enthusiast",
    },
  ...
  experiences: [
    {
      ...
      type: "Full-Time",
      description:
        "Serves as a full-stack developer for Sieitz, a company specializing in providing IT solutions. In this role, I am responsible for developing and maintaining web applications, collaborating with cross-functional teams to design scalable solutions, and ensuring the delivery of high-quality software products that meet client needs.",
      achievements: [
        "Developed SaaS-based web applications and has used with the clients to provide IT solutions",
        "Lead the development of a key project that resulted in a 20% increase in client satisfaction",
        "Collaborated with cross-functional teams to design and implement scalable solutions, improving system performance",
      ],
      tech: [
        "Laravel",
        "React",
