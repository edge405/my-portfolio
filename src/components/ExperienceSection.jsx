...
export default function ExperienceSection() {
  ...
  const getTypeColor = (type) => {
    ...
    return (
      colors[type] || "bg-purple-500/20 text-purple-300 border-purple-400/30"
    );
  };
            ...
            >
              ...
              <div className="relative flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <span
                    className={`px-4 py-1.5 rounded-full text-sm font-medium border ${getTypeColor(exp.type)}`}
                  >
                    {exp.type}
                  </span>
        ...
        {hasMoreItems && (
          <div className="flex justify-center mt-10">
            <button
              ...
              className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white px-6 py-3 rounded-full font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 cursor-pointer"
            >
              <span>
                {showAll
                  ? "Show Less"
