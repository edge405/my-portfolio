...
export default function App() {
  ...
  const experiences = [
    {
      ...
      achievements: [
        'Built end-to-end web applications using Python Flask and React',
    ...
    },
    {
      ...
      period: '2024 - Present',
      type: 'Learning',
      description: 'Actively learning DevOps practices and tools to transition from development to operations.',
      achievements: [
        'Learning containerization with Docker',
        'Exploring cloud platforms (AWS, GCP)',
        'Studying CI/CD pipelines and automation',
  ...
  const displayedExperiences = showAll ? experiences : experiences.slice(0, INITIAL_ITEMS);
  const hasMoreItems = experiences.length > INITIAL_ITEMS;
  const projects = [
    {
      id: 1,
      title: 'Multi-Course Thesis Management System',
      description: 'A comprehensive platform for managing thesis submissions, reviews, and approvals across multiple academic courses.',
      longDescription: 'This system streamlines the entire thesis lifecycle from proposal to final defense, featuring role-based access control, automated notifications, and document version management.',
      tech: ['Python Flask', 'PostgreSQL', 'JavaScript', 'HTML/CSS'],
      status: 'Completed',
      category: 'web',
      features: ['User Authentication', 'Document Management', 'Role-based Access', 'Email Notifications'],
    ...
    },
    {
      ...
      description: 'An innovative thesis system developed as graduation requirement, showcasing advanced full-stack development skills.',
      longDescription: 'Built with modern web technologies, this project demonstrates proficiency in both frontend and backend development with emphasis on user experience and system reliability.',
      tech: ['React', 'Python Flask', 'PostgreSQL', 'Postman'],
      status: 'Completed',
      category: 'web',
      features: ['Modern UI/UX', 'API Testing', 'Database Optimization', 'Responsive Design'],
    ...
    },
    {
      ...
      description: 'A collection of DevOps experiments and learning projects including containerization and automation scripts.',
      longDescription: 'Personal playground for learning DevOps tools and practices, featuring Docker containers, automation scripts, and cloud deployment examples.',
      tech: ['Docker', 'Linux', 'Bash', 'AWS'],
      status: 'In Progress',
      category: 'devops',
      features: ['Containerization', 'Automation', 'Cloud Deployment', 'Monitoring'],
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Exploring the transition from traditional development roles to the exciting world of DevOps engineering and infrastructure automation.",
      content: "As a fresh graduate with a strong foundation in full-stack development, I've begun my journey into DevOps...",
      date: "2024-12-15",
      readTime: "5 min",
      category: "Career",
    ...
    },
    {
      ...
      excerpt: "Lessons learned while developing thesis management systems for multiple courses and the challenges overcome.",
      content: "During my final year, I had the unique opportunity to work on thesis management systems...",
      date: "2024-11-28",
      readTime: "7 min",
    ...
    },
    {
      ...
      excerpt: "A beginner-friendly guide to containerizing Python Flask applications using Docker.",
      content: "Containerization has become essential in modern development workflows...",
      date: "2024-11-10",
      readTime: "6 min",
      category: "DevOps",
    ...
    },
    {
      ...
      excerpt: "Common React mistakes and the best practices I discovered through real project experience.",
      content: "Working on multiple React projects taught me valuable lessons...",
      date: "2024-10-22",
      readTime: "8 min",
      category: "Development",
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center text-gray-400 mb-12 space-y-4 sm:space-y-0 sm:space-x-8 text-base sm:text-lg">
            <div className="flex items-center">
              ...
              <span className="text-sm sm:text-base">Iloilo City, Philippines</span>
            </div>
            <div className="flex items-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Fresh graduate with hands-on experience in full-stack development. Passionate about creating robust systems and continuously learning new technologies to build efficient and scalable applications
          </p>
          {/* Stats */}
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <button
              ...
              className="group bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all transform hover:scale-105 flex items-center justify-center"
            >
              View My Work
            ...
            <button
              ...
              className="border-2 border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all hover:scale-105 flex items-center justify-center"
            >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                I'm a passionate 21-year-old developer from Iloilo City, Philippines. Recently graduated with a strong foundation in full-stack development, I've worked extensively with Python Flask, React, and PostgreSQL to build robust web applications.
              </p>
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
Through creating comprehensive management systems, I’ve developed a strong focus on writing clean code, designing scalable architectures, and prioritizing user-centered solutions.

              </p>
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
Currently, I'm further honing my backend and infrastructure skills exploring containerization with Docker, cloud platforms like AWS, and automation tools to build more efficient and scalable systems.              </p>
              <div className="flex space-x-4">
                <a href="https://github.com/edge405" className="text-purple-400 hover:text-purple-300 transition-colors">
                  <Github size={28} />
                </a>
                <a href="https://www.linkedin.com/in/edjay404/" className="text-blue-400 hover:text-blue-300 transition-colors">
                  <Linkedin size={28} />
                </a>
                <a href="https://www.facebook.com/edjay.leo" className="text-blue-400 hover:text-blue-300 transition-colors">
                  <Facebook size={28} />
                </a>
              </div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300">Based in Iloilo City, Philippines</span>
                </div>
                <div className="flex items-center">
                  <Zap className="text-red-400 mr-3" size={20} />
                  <span className="text-gray-300">Active participant in hackathon events</span>
                </div>
                <div className="flex items-center">
                  <Code className="text-blue-400 mr-3" size={20} />
                  <span className="text-gray-300">Full-stack developer who honed skills developing thesis projects</span>
                </div>
                <div className="flex items-center">
                  <Award className="text-green-400 mr-3" size={20} />
                  <span className="text-gray-300">Fresh Computer Science Graduate</span>
                </div>
                <div className="flex items-center">
                  <Coffee className="text-yellow-400 mr-3" size={20} />
                  <span className="text-gray-300">Powered by coffee and curiosity</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-center">
          ...
          >
            <span className="flex items-center space-x-2 cursor-pointer">
              <span>{showAll ? 'See Less' : `See More (${experiences.length - INITIAL_ITEMS} more)`}</span>
              <svg 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 group hover:bg-white/10 transition-all">
                ...
                <p className="text-gray-300 text-sm mt-2 text-right">{skill.level}%</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="projects" className="relative py-20 px-4 z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-300 text-center mb-12 max-w-2xl mx-auto">
            Here are some of the projects I've worked on, showcasing my skills in full-stack development and DevOps practices.
          </p>
...
<div className="overflow-x-auto scroll-smooth snap-x snap-mandatory scrollbar-thin scrollbar-thumb-purple-500/50 scrollbar-track-transparent hover:scrollbar-thumb-purple-500/70 pb-4">
  <div className="flex gap-6 w-max">
    {filteredProjects.map((project) => (
          <div key={project.id} className="bg-white/5 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10 group hover:bg-white/10 transition-all flex-shrink-0 w-80">
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((tech, i) => (
                  <span key={i} className="bg-purple-500/20 text-purple-300 px-2 py-1 rounded-lg text-xs">
                    {tech}
                  </span>
                ))}
              </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-300 text-center mb-12 max-w-2xl mx-auto">
          Sharing my journey, learnings, and insights in development and DevOps.
        </p>
        ...
        <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-purple-500/50 scrollbar-track-transparent hover:scrollbar-thumb-purple-500/70 pb-4">
          <div className="flex gap-6 w-max">
            {blogPosts.map((post) => (
              <article key={post.id} className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 group hover:bg-white/10 transition-all flex-shrink-0 w-96">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {post.tags.map((tag, i) => (
                    <span key={i} className="bg-blue-500/20 text-blue-300 px-2 py-1 rounded-lg text-xs flex items-center">
                      <Tag size={12} className="mr-1" />
                      {tag}
                    </span>
                  ))}
                </div>
                <button className="text-purple-400 hover:text-purple-300 transition-colors font-medium flex items-center">
                  Read More
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <a href="https://linkedin.com/in/edjay" className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all group">
              <Linkedin className="text-blue-400 mx-auto mb-4 group-hover:scale-110 transition-transform" size={48} />
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-4 rounded-xl font-semibold transition-all hover:scale-105 cursor-pointer"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-6 mb-8">
              <a href="https://github.com/edjay" className="text-gray-400 hover:text-white transition-colors">
                <Github size={24} />
              </a>
              <a href="https://linkedin.com/in/edjay" className="text-gray-400 hover:text-white transition-colors">
                <Linkedin size={24} />
              </a>
              <a href="mailto:edjay@example.com" className="text-gray-400 hover:text-white transition-colors">
                <Mail size={24} />
              </a>
            </div>
            <div className="border-t border-white/10 pt-8">
              <p className="text-gray-500 text-sm">
                © 2024 Edjay Lindayao. Built with React and lots of ☕. All rights reserved.
              </p>
            </div>
          </div>
        </div>
